...
function getQuestionTemplate(type?: QuestionType): string {
  switch (type) {
    ...
    case 'sentence':
      ...
      return '読解力を養うために短文の内容理解を問う選択問題を作成します。テキストから1〜2文程度を抜き出し、その内容について最も正しい説明を4つの選択肢(うち正解1つ、不正解3つ)で作成してください。正解/不正解の順番はランダムにしてください。問題の元となった英文も含めてください。';
    case 'translation':
...
問題は選択問題の形式で、間違いが３つ正解が１つの４択問題で正解の選択肢はランダムに配置してください。
